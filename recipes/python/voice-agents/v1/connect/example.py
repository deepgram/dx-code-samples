...
settings using the Deepgram Agent API.

A voice agent has three stages: listen (STT), think (LLM), speak (TTS).
This recipe configures all three and opens a WebSocket connection.
The agent processes audio input and generates spoken responses.
"""
...
def main():
    ...
    with client.agent.v1.connect() as agent:
        ...
        print("Voice agent session configured")

        def on_message(message: AgentResponse) -> None:
